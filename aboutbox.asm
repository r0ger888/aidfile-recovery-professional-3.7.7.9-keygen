...
.data
	...
	szaText	db	13,13,13,13,13
		...
		db      13,13,13,13
		db  "  Target     : A.R.P<3.7.7.9>   ",13
		db  "  Cracker    : GRUiA            ",13
		db  "  Date       : 19.jun.2o24      ",13
		db  "  Protection : RSA-128          ",8
 		db	13,13
 		db	"  10x 2:                         ",13,13
		db  "   r0ger 4 CooL GFX              ",13
		db  "   Alfonso 4 CooL Spiral         ",13
		db  "   Dalezy 4 CooL Music         ",13
 		db	"   x0man 4 CooL About Template   ",13
 		db  "   MagicH 4 MagicV2mEngine     ",8
		...
		db  "  ShTEFY....................[PRF]  ",13
 		...
 		db  13,"  Bl4ckCyb3rEnigm4...............  ",13
 		db  "  kao..................[tuts4you]  ",13
 		db  "  JonArbuckle..............[TSRh]  ",13
 		db  "  Wha!ted................[DiSiRE]  ",13
		...
		db  "  discord  : r0ger888.............  ",13
 		...
 		db  "  telegram : t.me/r0ger888........  ",8
 		db  13,13,13,13
 		db  "  our distro :                      ",13,13
 		db  "  ..distro.cracksurl.com/team-prf/  ",8,0
...
LOCAL rect:RECT
	...
	.if eax == WM_INITDIALOG
		...
		invoke CreateRoundRectRgn, 1, 0, aWidth, aHeight, 40, 40
		invoke SetWindowRgn, yWnd, eax, TRUE
