...
ScrollText	    		db	"PERYFERiAH kLAN presentz a new release made by ur bro GRUiA! :: gfx by r0ger "
						db  ":: msx by Dalezy ...                                                                                                     "
						...
						db  "Talers, Jowy, Dilik, Vad1m, Whaited, Bang1338, Log0, Sunsay and many many other ppl.                               "
						db  "               just coded a spiral as u can see ..... it flickers a bit but it's ok. "
						db  "perhaps i'll find a way to fix this problem. or depends if i am making another template "
						db  "with this spiral... ~ r0ger",0
scr						SCROLLER_STRUCT <>
lf						LOGFONT<>
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,0
		mov scr.scroll_y,236
		
		mov scr.scroll_width,460
